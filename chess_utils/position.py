...
class Position:
    ...
    def piece_at(self, sqr_index):
        """
        Returns the FEN symbol of the piece at the given square index (0-63).
        sqr_index 0 is a1, 7 is h1, 56 is a8, 63 is h8.
        Returns None if the square is empty.
        """
        # The self.squares array is indexed such that squares[0] is a8, squares[7] is h8,
        # squares[56] is a1, squares[63] is h1, due to `index ^ 56` in init_squares_from_fen.
        # Standard square index (sqr_index): a1=0, h8=63
        # The conversion is: internal_index = sqr_index ^ 56
        internal_sq_index = sqr_index ^ 56
        
        piece_int = self.squares[internal_sq_index]
        # NO_PIECE should be imported from consts
        if piece_int == NO_PIECE: 
            return None
        
        # piece_int_to_string should be imported from common
        return piece_int_to_string[piece_int]
